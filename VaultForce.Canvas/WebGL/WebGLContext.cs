...
namespace VaultForce.Canvas.WebGL
{
    public class WebGLContext : RenderingContext
    {
        ...
        public WebGLContext(BeCanvas reference, WebGLContextAttributes? attributes = null, string contextName = CONTEXT_NAME) : base(reference, contextName, attributes)
        {
        }
